...
function draw() {
  ...
  textSize(20)
  fill("white")
  text("Bullets = " + bullets, displayWidth - 210, displayHeight / 2 - 370)
  text("Score = " + score, displayWidth - 200, displayHeight / 2 - 340)
  text("Lives = " + life, displayWidth - 200, displayHeight / 2 - 400)
  ...
  //destroy zombie, player and bullets and display a message in gameState "bullet"
    ...
    textSize(50)
    fill("yellow")
    text("You ran out of bullets!!!", 770, 610)
    zombieGroup.destroyEach();
    player.destroy();
